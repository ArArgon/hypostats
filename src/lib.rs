...
fn pg_class_stat_load(
    ...
    let table_lock = Relation::new(oid, pg_sys::RowExclusiveLock as i32);
...
#[pg_extern]
fn pg_class_stat_dump(rel_name: String, namespace: pg_sys::Oid) -> Option<PostgresClassStat> {
